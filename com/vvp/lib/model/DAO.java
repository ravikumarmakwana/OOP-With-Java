	...
	throws Exception
	{
		...
		if(f1.length()!=0)
		{
			...
			for(int i=0;i<part.length;i++)
			{
				...
				student.put(Integer.parseInt(element[0]),new Student(Integer.parseInt(element[0]),element[1],Integer.parseInt(element[2]),Integer.parseInt(element[3]),element[4],element[5]));
			}	
		}
		if(f2.length()!=0)
		{
